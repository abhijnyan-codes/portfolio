...
export default function About() {
  ...
  const [prCount, setPrCount] = useState(10); // Fallback count

  // Fetch live merged PRs from GitHub
  useEffect(() => {
    fetch('https://api.github.com/search/issues?q=author:abhijnyan-codes+type:pr+is:merged')
      .then((res) => res.json())
      .then((data) => {
      ...
      .catch((error) => console.error('Error fetching GitHub PRs:', error));
  }, []);
  ...
  const stats = [
    ...
    { value: 66, suffix: "+", label: "DSA Solved", pad: false, float: false },
    { value: 3, suffix: "+", label: "Products Built", pad: true, float: false },
    { value: 6.95, suffix: "", label: "CGPA", pad: false, float: true }
  ];
  ...
  return (
    ...
    >
      {/* Atmosphere & Parallax Background */}
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16 lg:gap-24 items-start">
          ...
          {/* LEFT COLUMN: Selected Highlights */}
          ...
          <div className="flex flex-col justify-center pt-8 lg:pt-16">
            ...
            >
              ...
              <Link href="https://www.linkedin.com/in/abhijnyan-saikia-458400298/" target="_blank" rel="noopener noreferrer" className="group relative h-14 px-7 rounded-full bg-white/[0.03] border border-white/10 text-white flex items-center justify-center gap-3 transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:-translate-y-1">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="opacity-90"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
